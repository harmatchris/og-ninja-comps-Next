...
const App=()=>{
  ...
  const [view,setView]=useState(()=>{if(modeP==='display')return 'display';if(modeP==='queue')return 'queue';if(modeP==='stats')return 'stats';if(modeP==='skill')return 'skill';if(stageIdP&&compP)return 'jury';if(stP&&compP)return 'jury';if(compP)return 'coordinator';return 'home';});
